...
static void usage(void)
{
	...
	printf(
		...
		"     -e <ESSID>   : ESSID of the network to filter\n"
		"        or\n"
		"     -b <BSSID>   : BSSID of the network to filter\n"
		"\n"
		"   Optional:\n"
		...
		"invalid_status.pcap)\n"
		"     -f <filters> : apply filters (separated by a comma), filters:\n"
		...
		"these\n"
		"                                 filters one by one)\n"
		"     -n           : assume that null packets can be "
		"cloaked\n"
		"     -a           : do not apply base filter\n"
		//"     -r           : disable retry check, don't care about
		// retry bit\n"
		"     -d           : drop fragmented packets\n"
		"\n"
